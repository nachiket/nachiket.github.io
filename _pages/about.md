...
I am a Professor at <span class="affiliation">{% include affiliation-icon.html organization="waterloo" %} [University of Waterloo](https://uwaterloo.ca/electrical-computer-engineering/)</span> and a Visiting Fellow at <span class="affiliation">{% include affiliation-icon.html organization="tenstorrent" %} [Tenstorrent](https://tenstorrent.com/)</span>. Previously, I was Research Director at <span class="affiliation">{% include affiliation-icon.html organization="amd" %} Xilinx Labs (now [AMD Research](https://www.amd.com/en/corporate/research.html))</span> Singapore, CTO of <span class="affiliation">{% include affiliation-icon.html organization="lattice" %} Plunify (now part of [Lattice Semiconductor](https://www.latticesemi.com/))</span>, and an Assistant Professor at <span class="affiliation">{% include affiliation-icon.html organization="ntu" %} [Nanyang Technological University](https://www.ntu.edu.sg/)</span>.
