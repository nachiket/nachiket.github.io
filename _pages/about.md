...
I am a Professor at <span class="affiliation"><i class="fa-solid fa-building-columns affiliation-glyph" aria-hidden="true"></i> [University of Waterloo](https://uwaterloo.ca/electrical-computer-engineering/)</span> and a Visiting Fellow at <span class="affiliation"><i class="fa-solid fa-microchip affiliation-glyph" aria-hidden="true"></i> [Tenstorrent](https://tenstorrent.com/)</span>. Previously, I was Research Director at <span class="affiliation"><i class="fa-solid fa-microchip affiliation-glyph" aria-hidden="true"></i> Xilinx Labs (now [AMD Research](https://www.amd.com/en/corporate/research.html))</span> Singapore, CTO of <span class="affiliation"><i class="fa-solid fa-chart-line affiliation-glyph" aria-hidden="true"></i> Plunify (now part of [Lattice Semiconductor](https://www.latticesemi.com/))</span>, and an Assistant Professor at <span class="affiliation"><i class="fa-solid fa-building-columns affiliation-glyph" aria-hidden="true"></i> [Nanyang Technological University](https://www.ntu.edu.sg/)</span>.
